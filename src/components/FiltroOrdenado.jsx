  ...
  render() {
    return (
      <div>
        ...
        <input value="ASC" data-testid='column-sort-input' name="order" type="radio" onClick={(event) =>
          this.setState({sort: (event.target.value)})}
        /> ASC
        <input value="DESC" data-testid='column-sort-input' name="order" type="radio" onClick={(event) =>
          this.setState({sort: (event.target.value)})}/> DESC
        <button
